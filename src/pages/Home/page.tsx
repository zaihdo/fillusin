		...
		<Flex
			...
			<Flex
				...
				<Text variant="body-default-m" onBackground="accent-medium">
					<TypewriterEffect
						text="As conflict intensifies, the people of Gaza urgently seek to evacuate through the Rafah border crossing, 
                    ...
                    Each link has been directly sourced from those in need, ensuring your support reaches them promptly."
						speed={25}></TypewriterEffect>
				</Text>
			</Flex>
			<Flex
				fillWidth
				...
				direction="column"
				gap="s">
				<Flex fillWidth mobileDirection="row" gap="1">
					<Flex position="relative" fillWidth direction="column" gap="24">
						<Text variant="display-default-xs" onBackground="neutral-strong">
							<Text style={{ color: "#01b760" }}>Read their stories.</Text>
							<br />
							<Text style={{ color: "#d83838" }}>Donate to the cause.</Text>
							<br />
							<Text color="#fff">Share Share Share.</Text>
						</Text>
						<Button
